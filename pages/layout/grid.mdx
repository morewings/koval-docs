...
For detailed examples, refer to the [Storybook documentation](https://morewings.github.io/koval-ui/?path=/docs/layout-grid--docs).
...
See [all Col props](https://morewings.github.io/koval-ui/?path=/docs/layout-grid--docs#col-props).
